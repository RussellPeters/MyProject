...
abstract public class AbstractPacketizer {
	...
	protected VideoGciBuffs myBuff;
	
	protected ByteBufferManager myEncoderBuffer;
	
	protected ByteBufferManager myJpegBuffer;
	...
	public void setMyBuff(VideoGciBuffs buff) {
		this.myBuff = buff;
	}
	
	public void setEncoderBuffer(ByteBufferManager buff){
		this.myEncoderBuffer = buff;
	}
	
	public void setJpengBuffer(ByteBufferManager myjpegbuff){
		this.myJpegBuffer = myjpegbuff;
	}
